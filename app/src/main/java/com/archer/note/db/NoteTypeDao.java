...
public class NoteTypeDao extends AbstractDao<NoteType, Long> {
    ...
    */
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, NoteType entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void attachEntity(NoteType entity) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(NoteType entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
